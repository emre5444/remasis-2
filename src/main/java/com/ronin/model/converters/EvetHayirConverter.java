...
@ManagedBean
@RequestScoped
public class EvetHayirConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String newValue) {
        EvetHayir entity = null;
        if (newValue != null && !newValue.equals("Seçiniz")) {
            try {
                Long entityId = new Long(newValue);

                return ortakService.getEntityByClass(EvetHayir.class , entityId);
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        if (value != null) {
            try {
                EvetHayir entity = (EvetHayir) value;
