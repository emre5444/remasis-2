...
@ManagedBean
@RequestScoped
public class KullaniciTipiConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String newValue) {
        if (newValue != null && !newValue.equals("Seçiniz")) {
            try {
                ...
                return ortakService.getEntityByClass(KullaniciTipi.class , entityId);
            } catch (Throwable ex) {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        if (value != null) {
            try {
                KullaniciTipi entity = (KullaniciTipi) value;
