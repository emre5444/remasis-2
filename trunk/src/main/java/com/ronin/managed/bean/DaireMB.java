...
@ViewScoped
public class DaireMB implements Serializable {
    ...
    public void update(Daire daire) {
        try {
            ...
            requestContext.execute("PF('daireGuncellemePopup').hide()");
        } catch (Exception e) {
