...
public class RandevuMB extends AbstractMB implements Serializable {
    ...
    public boolean verify() {
        ...
        Long aktifRandevuVarMý = randevuService.hasAktifRandevu(sorguKriteri.getRandevuTipi(), event.getStartDate(), event.getEndDate(), sessionInfo);
        if (aktifRandevuVarMý > 0 && !sessionInfo.isYetkili("tenis_randevu_onayi")) {
